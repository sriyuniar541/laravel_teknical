@extends('index') @section('title', 'Keranjang Pembeli') @section('content')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex">
                    ...
                    <form action="{{url('/purchases/purc/'.$dataProduct->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf @method('PUT')
                ...
                @else
                    ...
                    <form action="{{ url('/purchases/purc/'.$item->id) }}" method="POST"
