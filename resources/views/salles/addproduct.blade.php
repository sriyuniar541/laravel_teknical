@extends('index') @section('title', 'Penjualan') @section('content') 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST"   onsubmit="return confirm('Apakah anda yakin akan menghapus data ini ?')" enctype="multipart/form-data" action="{{ url('/product/sal/'.$item->id) }}">
                        @csrf
                        @method('DELETE')
                ...
                <form
                    action="{{url('/product/sal/'.$dataProduct->id)}}"
                    method="POST"
                    enctype="multipart/form-data"
                >
                    @csrf @method('PUT')
